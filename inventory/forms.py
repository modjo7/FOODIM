...
class StockForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['expdate'].widget.attrs.update(
            {'class': 'textinput form-control', 'pattern': '[0-2][0-2][0-9][0-9]-[0-1][0-9]-[0-3][0-9]', 'title': 'Date type YYYY-MM-DD only'})
    ...
    class Meta:
        model = Stock
        fields = ['name', 'itemname', 'quantity',
                  'username', 'expdate', 'desc']
